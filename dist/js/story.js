...
export function buildCategoryIntro(cat){const intro=cat.intro||{};const s=section(`cat-${cat.id}`,cat.mood||"paper",cat.label,"cat-intro");const accent=getLang()==="ar"?intro.subtitle?.en:intro.subtitle?.ar;const accentDir=getLang()==="ar"?'lang="en" dir="ltr"':'lang="ar" dir="rtl"';s.innerHTML=`
    ...
    <div class="narrative__content narrative__content--center">
      ...
      ${cat.note ? `<p class="cat-intro__note"data-enter="rise"data-enter-at="0.56">${t(cat.note)}</p>` : ""}
    </div>
    <div class="swipe-hint" aria-hidden="true" data-enter="fade" data-enter-at="0.7">
